...
const CalculatorNav = () => {
  ...
  return (
    <div className='calc-grid'>
      ...
      <div
        onClick={() => goToPageAndScroll('/calculator/vat', 'vatSection')}
        className={isVatActive ? "calc-box active" : "calc-box"}
      >
      ...
      <div
        onClick={() => goToPageAndScroll('/calculator/paye', 'payeSection')}
        className={isPayeActive ? "calc-box active" : "calc-box"}
      >
        <div className='calc-icon'>
      ...
      <div
        onClick={() => goToPageAndScroll('/calculator/business', 'businessSection')}
        className={isBusinessActive ? "calc-box active" : "calc-box"}
      >
        <div className='calc-icon'>
          <svg xmlns="http://www.w3.org/2000/svg" width="30px" height="30px" viewBox="0 0 20 20" fill="none">
            <rect x="0.5" y="0.5" width="17" height="17" stroke="#082B42" strokeWidth="0.8" rx="2"/>
            <g transform="translate(3.4,3) scale(0.7)">
              <path d="M14 0H2V16H6V12H10V16H14V0ZM5 3H7V5H5V3ZM7 7H5V9H7V7ZM9 3H11V5H9V3ZM11 7H9V9H11V7Z"
              fill="none" stroke="#082B42" strokeWidth="1"/>
            </g>
          </svg>
        </div>
        <h3>Business Tax</h3>
      ...
      <div
        onClick={goToGuide}
        className={isGuideActive ? "calc-box active" : "calc-box"}
      >
        <div className='calc-icon'>
          <svg xmlns="http://www.w3.org/2000/svg" width="30px" height="30px" viewBox="0 0 24 24" fill="none">
            ...
            />
            <path d="M12 8.1001V17.6601" stroke="#082B42" strokeWidth="0.8" strokeLinecap="round" strokeLinejoin="round"/>
          </svg>
        </div>
